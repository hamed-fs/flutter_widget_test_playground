...
part 'rendering/render_sliver_sticky_header.dart';
part 'rendering/sticky_header_constraints.dart';
part 'rendering/sticky_header_layout_builder.dart';
part 'sticky_header_layout_builder.dart';
...
class SliverStickyHeader extends RenderObjectWidget {
  ...
  @override
  _RenderSliverStickyHeader createRenderObject(BuildContext context) {
  ...
  void updateRenderObject(
      BuildContext context, _RenderSliverStickyHeader renderObject) {
    renderObject
      ..overlapsContent = overlapsContent
      ..sticky = sticky
      ..controller = controller ?? DefaultStickyHeaderController.of(context);
...
class SliverStickyHeaderRenderObjectElement extends RenderObjectElement {
  ...
  void insertChildRenderObject(RenderObject child, int slot) {
    final _RenderSliverStickyHeader renderObject = this.renderObject;
