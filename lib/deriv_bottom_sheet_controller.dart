...
import 'package:flutter_widget_test_playground/deriv_bottom_sheet_bloc.dart';

class DerivBottomSheetController extends ValueNotifier<bool> {
  DerivBottomSheetBloc _bloc = DerivBottomSheetBloc();

  // This is the current height of the bottomSheet's body
  double _height;

  DerivBottomSheetController() : super(false);
